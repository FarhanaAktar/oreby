...
setLastPage(event.selected === pageCount -1);
  ...
  return (
    <>
    <Flex  className={"gap-x-[34px] justify-center flex-wrap gap-y-[50px]"}>
    <Items currentItems={currentItems} />
      ...
      activeClassName="bg-black text-white"
        ...
        nextLabel={`Products from  ${itemOffset === 0 ? 1 : itemOffset} to ${lastPage ?items.length:
        endOffset} of ${items.length}`}
